...
// DO NOT EDIT.
// source: capnp/persistor.capnp


pub mod persist_data_series {
  #[derive(Copy, Clone)]
  pub struct Owned(());
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_values(&mut self, value: ::capnp::struct_list::Reader<'a,crate::schemas::persistor_capnp::persist_data_series::data_point::Owned>) -> ::capnp::Result<()> {
      ::capnp::traits::SetPointerBuilder::set_pointer_builder(self.builder.reborrow().get_pointer_field(1), value, false)
    }
    #[inline]
    pub fn init_values(self, size: u32) -> ::capnp::struct_list::Builder<'a,crate::schemas::persistor_capnp::persist_data_series::data_point::Owned> {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 76] = [
      ...
      ::capnp::word(114, 115, 105, 115, 116, 111, 114, 46),
      ...
      ::capnp::word(126, 55, 143, 134, 110, 192, 140, 138),
      ::capnp::word(9, 0, 0, 0, 74, 0, 0, 0),
      ::capnp::word(245, 12, 236, 170, 27, 196, 214, 175),
  ...
  impl ::capnp::traits::HasTypeId for DataType {
    const TYPE_ID: u64 = 0x8a8c_c06e_868f_377eu64;
  }
  mod data_type {
  pub static ENCODED_NODE: [::capnp::Word; 39] = [
    ...
    ::capnp::word(99, 97, 112, 110, 112, 58, 80, 101),
    ::capnp::word(114, 115, 105, 115, 116, 68, 97, 116),
    ::capnp::word(97, 83, 101, 114, 105, 101, 115, 46),
    ::capnp::word(68, 97, 116, 97, 84, 121, 112, 101),
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
  ...
  pub mod data_point {
    ...
    impl <'a,> Builder<'a,>  {
      ...
      #[inline]
      pub fn init_data(mut self, ) -> crate::schemas::persistor_capnp::persist_data_series::data_point::data::Builder<'a> {
    ...
    impl Pipeline  {
      pub fn get_data(&self) -> crate::schemas::persistor_capnp::persist_data_series::data_point::data::Pipeline {
    ...
    mod _private {
      pub static ENCODED_NODE: [::capnp::Word; 45] = [
        ...
        ::capnp::word(1, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(1, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(67, 199, 166, 78, 114, 188, 142, 131),
      ...
      pub static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
      pub const TYPE_ID: u64 = 0xafd6_c41b_aaec_0cf5;
    }
    ...
    pub mod data {
      ...
      mod _private {
        ...
        pub const TYPE_ID: u64 = 0x838e_bc72_4ea6_c743;
      }
...
pub mod fetch_data_series {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 34] = [
      ::capnp::word(0, 0, 0, 0, 5, 0, 6, 0),
      ::capnp::word(63, 240, 190, 185, 75, 59, 213, 161),
      ...
      ::capnp::word(99, 97, 112, 110, 112, 47, 112, 101),
      ::capnp::word(114, 115, 105, 115, 116, 111, 114, 46),
      ::capnp::word(99, 97, 112, 110, 112, 58, 70, 101),
      ::capnp::word(116, 99, 104, 68, 97, 116, 97, 83),
    ...
    pub static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
    pub const TYPE_ID: u64 = 0xa1d5_3b4b_b9be_f03f;
  }
}
