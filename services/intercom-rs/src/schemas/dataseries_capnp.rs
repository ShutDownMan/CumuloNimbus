...
// DO NOT EDIT.
// source: C:/Users/Jedson Gabriel/ws/CumuloNimbus/services/intercom/capnp/dataseries.capnp
...
pub mod data_series_metadata {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 89] = [
      ...
      ::capnp::word(100, 97, 116, 97, 115, 101, 114, 105),
      ::capnp::word(101, 115, 46, 99, 97, 112, 110, 112),
      ::capnp::word(58, 68, 97, 116, 97, 83, 101, 114),
      ::capnp::word(105, 101, 115, 77, 101, 116, 97, 100),
...
pub mod data_series { /* DataPointType */
  #[derive(Copy, Clone)]
  ...
  impl <'a,DataPointType> Reader<'a,DataPointType> where DataPointType: ::capnp::traits::Owned  {
    ...
    #[inline]
    pub fn get_values(self) -> ::capnp::Result<::capnp::struct_list::Reader<'a,crate::schemas::dataseries_capnp::data_point::Owned<DataPointType>>> {
      ::capnp::traits::FromPointerReader::get_from_pointer(&self.reader.get_pointer_field(1), ::core::option::Option::None)
    }
    #[inline]
  ...
  impl <'a,DataPointType> Builder<'a,DataPointType> where DataPointType: ::capnp::traits::Owned  {
    ...
    #[inline]
    pub fn get_values(self) -> ::capnp::Result<::capnp::struct_list::Builder<'a,crate::schemas::dataseries_capnp::data_point::Owned<DataPointType>>> {
      ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(1), ::core::option::Option::None)
    }
    #[inline]
    pub fn set_values(&mut self, value: ::capnp::struct_list::Reader<'a,crate::schemas::dataseries_capnp::data_point::Owned<DataPointType>>) -> ::capnp::Result<()> {
      ::capnp::traits::SetPointerBuilder::set_pointer_builder(self.builder.reborrow().get_pointer_field(1), value, false)
    }
    #[inline]
    pub fn init_values(self, size: u32) -> ::capnp::struct_list::Builder<'a,crate::schemas::dataseries_capnp::data_point::Owned<DataPointType>> {
  ...
  mod _private {
    ...
    pub fn get_field_types<DataPointType>(index: u16) -> ::capnp::introspect::Type where DataPointType: ::capnp::traits::Owned  {
      match index {
        ...
        1 => <::capnp::struct_list::Owned<crate::schemas::dataseries_capnp::data_point::Owned<DataPointType>> as ::capnp::introspect::Introspect>::introspect(),
        _ => panic!("invalid field index {}", index),
      }
    }
    ...
    pub static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
    pub const TYPE_ID: u64 = 0x9097_e99c_47d4_d73a;
  }
}
...
pub mod data_point { /* DataPointType */
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 61] = [
      ...
      ::capnp::word(100, 97, 116, 97, 115, 101, 114, 105),
      ::capnp::word(101, 115, 46, 99, 97, 112, 110, 112),
      ::capnp::word(58, 68, 97, 116, 97, 80, 111, 105),
...
pub mod numeric_data_point {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 42] = [
      ...
      ::capnp::word(100, 97, 116, 97, 115, 101, 114, 105),
      ::capnp::word(101, 115, 46, 99, 97, 112, 110, 112),
      ::capnp::word(58, 78, 117, 109, 101, 114, 105, 99),
      ::capnp::word(68, 97, 116, 97, 80, 111, 105, 110),
...
pub mod text_data_point {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 41] = [
      ...
      ::capnp::word(100, 97, 116, 97, 115, 101, 114, 105),
      ::capnp::word(101, 115, 46, 99, 97, 112, 110, 112),
      ::capnp::word(58, 84, 101, 120, 116, 68, 97, 116),
      ::capnp::word(97, 80, 111, 105, 110, 116, 0, 0),
      ::capnp::word(0, 0, 0, 0, 1, 0, 1, 0),
      ::capnp::word(4, 0, 0, 0, 3, 0, 4, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 1, 0, 0, 0, 0, 0),
