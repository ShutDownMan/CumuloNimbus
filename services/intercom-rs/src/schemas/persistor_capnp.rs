...
// DO NOT EDIT.
// source: C:/Users/Jedson Gabriel/ws/CumuloNimbus/services/intercom/capnp/persistor.capnp
...
pub static ENCODED_NODE: [::capnp::Word; 45] = [
  ...
  ::capnp::word(112, 101, 114, 115, 105, 115, 116, 111),
  ::capnp::word(114, 46, 99, 97, 112, 110, 112, 58),
  ::capnp::word(77, 101, 114, 103, 101, 83, 116, 114),
...
pub mod persist_data_series_options {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 59] = [
      ...
      ::capnp::word(112, 101, 114, 115, 105, 115, 116, 111),
      ::capnp::word(114, 46, 99, 97, 112, 110, 112, 58),
      ::capnp::word(80, 101, 114, 115, 105, 115, 116, 68),
      ::capnp::word(97, 116, 97, 83, 101, 114, 105, 101),
      ::capnp::word(115, 79, 112, 116, 105, 111, 110, 115),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 1, 0, 1, 0),
...
pub mod fetch_data_series {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 41] = [
      ...
      ::capnp::word(112, 101, 114, 115, 105, 115, 116, 111),
      ::capnp::word(114, 46, 99, 97, 112, 110, 112, 58),
      ::capnp::word(70, 101, 116, 99, 104, 68, 97, 116),
