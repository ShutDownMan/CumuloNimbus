...
pub mod persist_data_series {
  ...
  impl ::capnp::traits::HasTypeId for DataType {
    const TYPE_ID: u64 = 0xcf9e_68a2_c8b1_be2bu64;
  }
  mod data_type {
  pub static ENCODED_NODE: [::capnp::Word; 47] = [
    ::capnp::word(0, 0, 0, 0, 5, 0, 6, 0),
    ::capnp::word(43, 190, 177, 200, 162, 104, 158, 207),
    ::capnp::word(105, 0, 0, 0, 2, 0, 0, 0),
    ::capnp::word(192, 29, 206, 56, 198, 239, 186, 177),
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ::capnp::word(21, 0, 0, 0, 146, 3, 0, 0),
    ::capnp::word(77, 0, 0, 0, 7, 0, 0, 0),
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ::capnp::word(73, 0, 0, 0, 103, 0, 0, 0),
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
    ::capnp::word(67, 58, 47, 85, 115, 101, 114, 115),
    ::capnp::word(47, 74, 101, 100, 115, 111, 110, 32),
    ...
    ::capnp::word(101, 114, 115, 105, 115, 116, 68, 97),
    ::capnp::word(116, 97, 83, 101, 114, 105, 101, 115),
    ::capnp::word(46, 68, 97, 116, 97, 84, 121, 112),
  ...
  pub mod data_point {
    ...
    mod _private {
      pub static ENCODED_NODE: [::capnp::Word; 53] = [
        ::capnp::word(0, 0, 0, 0, 5, 0, 6, 0),
        ::capnp::word(57, 75, 39, 50, 237, 86, 107, 219),
        ::capnp::word(105, 0, 0, 0, 1, 0, 3, 0),
        ::capnp::word(192, 29, 206, 56, 198, 239, 186, 177),
        ::capnp::word(1, 0, 7, 0, 0, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(21, 0, 0, 0, 154, 3, 0, 0),
        ::capnp::word(77, 0, 0, 0, 7, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ...
        ::capnp::word(101, 114, 115, 105, 115, 116, 68, 97),
        ::capnp::word(116, 97, 83, 101, 114, 105, 101, 115),
        ::capnp::word(46, 68, 97, 116, 97, 80, 111, 105),
        ...
        ::capnp::word(1, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(1, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(148, 0, 104, 206, 8, 144, 245, 209),
    ...
    pub mod data {
      ...
      mod _private {
        pub static ENCODED_NODE: [::capnp::Word; 90] = [
          ::capnp::word(0, 0, 0, 0, 5, 0, 6, 0),
          ::capnp::word(148, 0, 104, 206, 8, 144, 245, 209),
          ::capnp::word(115, 0, 0, 0, 1, 0, 3, 0),
          ::capnp::word(57, 75, 39, 50, 237, 86, 107, 219),
          ::capnp::word(1, 0, 7, 0, 1, 0, 4, 0),
          ::capnp::word(8, 0, 0, 0, 0, 0, 0, 0),
          ::capnp::word(21, 0, 0, 0, 194, 3, 0, 0),
          ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
          ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
          ...
          ::capnp::word(116, 97, 83, 101, 114, 105, 101, 115),
          ::capnp::word(46, 68, 97, 116, 97, 80, 111, 105),
          ::capnp::word(110, 116, 46, 100, 97, 116, 97, 0),
        ...
        pub const TYPE_ID: u64 = 0xd1f5_9008_ce68_0094;
      }
