...
// DO NOT EDIT.
// source: src/schemas/persistor.capnp
...
pub mod data_series {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_type(self) -> ::core::result::Result<crate::schemas::persistor_capnp::data_series::DataType,::capnp::NotInSchema> {
      ::core::convert::TryInto::try_into(self.reader.get_data_field::<u16>(0))
    }
    #[inline]
    pub fn get_values(self) -> ::capnp::Result<::capnp::struct_list::Reader<'a,crate::schemas::persistor_capnp::data_series::data_point::Owned>> {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_type(&mut self, value: crate::schemas::persistor_capnp::data_series::DataType)  {
      self.builder.set_data_field::<u16>(0, value as u16);
    }
    #[inline]
    pub fn get_values(self) -> ::capnp::Result<::capnp::struct_list::Builder<'a,crate::schemas::persistor_capnp::data_series::data_point::Owned>> {
      ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(1), ::core::option::Option::None)
    }
    #[inline]
    pub fn set_values(&mut self, value: ::capnp::struct_list::Reader<'a,crate::schemas::persistor_capnp::data_series::data_point::Owned>) -> ::capnp::Result<()> {
      ::capnp::traits::SetPointerBuilder::set_pointer_builder(self.builder.reborrow().get_pointer_field(1), value, false)
    }
    #[inline]
    pub fn init_values(self, size: u32) -> ::capnp::struct_list::Builder<'a,crate::schemas::persistor_capnp::data_series::data_point::Owned> {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 76] = [
      ...
      ::capnp::word(189, 150, 89, 98, 104, 245, 88, 160),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(115, 114, 99, 47, 115, 99, 104, 101),
      ::capnp::word(109, 97, 115, 47, 112, 101, 114, 115),
      ::capnp::word(105, 115, 116, 111, 114, 46, 99, 97),
      ::capnp::word(112, 110, 112, 58, 68, 97, 116, 97),
      ::capnp::word(83, 101, 114, 105, 101, 115, 0, 0),
      ::capnp::word(8, 0, 0, 0, 1, 0, 1, 0),
      ::capnp::word(184, 144, 148, 126, 86, 59, 195, 253),
      ::capnp::word(9, 0, 0, 0, 74, 0, 0, 0),
      ::capnp::word(182, 169, 8, 219, 9, 104, 203, 205),
    ...
    pub fn get_field_types(index: u16) -> ::capnp::introspect::Type {
      match index {
        ...
        1 => <crate::schemas::persistor_capnp::data_series::DataType as ::capnp::introspect::Introspect>::introspect(),
        2 => <::capnp::struct_list::Owned<crate::schemas::persistor_capnp::data_series::data_point::Owned> as ::capnp::introspect::Introspect>::introspect(),
    ...
    pub const TYPE_ID: u64 = 0xa058_f568_6259_96bd;
  }
  ...
  impl ::capnp::traits::HasTypeId for DataType {
    const TYPE_ID: u64 = 0xfdc3_3b56_7e94_90b8u64;
  }
  mod data_type {
  pub static ENCODED_NODE: [::capnp::Word; 38] = [
    ...
    ::capnp::word(105, 115, 116, 111, 114, 46, 99, 97),
    ::capnp::word(112, 110, 112, 58, 68, 97, 116, 97),
    ::capnp::word(83, 101, 114, 105, 101, 115, 46, 68),
    ::capnp::word(97, 116, 97, 84, 121, 112, 101, 0),
  ...
  pub mod data_point {
    ...
    impl <'a,> Reader<'a,>  {
      ...
      #[inline]
      pub fn get_data(self) -> crate::schemas::persistor_capnp::data_series::data_point::data::Reader<'a> {
        self.reader.into()
      }
    }
    ...
    impl <'a,> Builder<'a,>  {
      ...
      #[inline]
      pub fn get_data(self) -> crate::schemas::persistor_capnp::data_series::data_point::data::Builder<'a> {
        self.builder.into()
      }
      #[inline]
      pub fn init_data(mut self, ) -> crate::schemas::persistor_capnp::data_series::data_point::data::Builder<'a> {
    ...
    impl Pipeline  {
      pub fn get_data(&self) -> crate::schemas::persistor_capnp::data_series::data_point::data::Pipeline {
    ...
    mod _private {
      pub static ENCODED_NODE: [::capnp::Word; 45] = [
        ...
        ::capnp::word(1, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(1, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(204, 35, 116, 196, 77, 65, 66, 133),
      ...
      pub fn get_field_types(index: u16) -> ::capnp::introspect::Type {
        match index {
          ...
          1 => <crate::schemas::persistor_capnp::data_series::data_point::data::Owned as ::capnp::introspect::Introspect>::introspect(),
          _ => panic!("invalid field index {}", index),
        }
      }
      pub fn get_annotation_types(child_index: Option<u16>, index: u32) -> ::capnp::introspect::Type {
      ...
      pub static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
      pub const TYPE_ID: u64 = 0xcdcb_6809_db08_a9b6;
    }
    ...
    pub mod data {
      ...
      mod _private {
        ...
        pub const TYPE_ID: u64 = 0x8542_414d_c474_23cc;
      }
